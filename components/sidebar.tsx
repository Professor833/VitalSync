    ...
    <aside className="w-64 bg-card text-card-foreground p-6 space-y-8 hidden md:flex md:flex-col">
      ...
      <nav className="flex-grow">
        <ul className="space-y-2">
          <li>
            <Link
              href="/dashboard"
              className="flex items-center space-x-3 py-2.5 px-4 rounded-md transition-colors duration-200 hover:bg-accent hover:text-primary text-muted-foreground"
            >
          ...
          <li>
            <Link
              href="/dashboard/hydration-tracker"
              className="flex items-center space-x-3 py-2.5 px-4 rounded-md transition-colors duration-200 hover:bg-accent hover:text-accent-foreground text-muted-foreground"
            >
      ...
      <div className="mt-auto text-center">
        <p className="text-xs text-muted-foreground">
          &copy; {new Date().getFullYear()} VitalSync
        </p>
      </div>
    </aside>
  );
